...
The current version works if I hack it by downloading a folder and reuploading, otherwise it seems that the GDrive api isn't able to see every file in every folder, only every file that I personally opened/downloaded?
